...
const contactLinks = [
  {
    label: "Email",
    value: "sajidmostafiznoor@gmail.com",
  ...
  {
    label: "LinkedIn",
    value: "linkedin.com/in/sajid-mostafiz-noor",
  ...
  {
    label: "GitHub",
    value: "github.com/SajidNoor5051",
  ...
  {
    label: "Facebook",
    value: "facebook.com/sajid.mostafiz.noor",
    ...
    <section id="contact" className="py-20 bg-portfolio-background">
      <div className="project-card container mx-auto px-4 md:px-8 lg:px-16 max-w-4xl font-style">
        ...
        <p className="text-base text-gray-800 leading-relaxed mb-10">
          I am open to research collaborations, academic discussions, and
          professional opportunities. Feel free to reach out through any of the
          channels below.
        </p>
        ...
        <div className="space-y-3">
          {contactLinks.map((item) => (
            <div
              key={item.label}
              className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-6 pl-4 border-l-2 border-gray-200 py-1"
            >
              <span className="text-xs font-semibold uppercase tracking-widest text-gray-500 w-24 flex-shrink-0">
                {item.label}
              </span>
              <a
                href={item.href}
